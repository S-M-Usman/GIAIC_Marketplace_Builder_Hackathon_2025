...
export default function FeaturedSection () {
  ...
  <div className="px-4 py-8 text-center items-center w-[1008px] h-[229px]">
    ...
    <Button variant="default" size="lg" className="rounded-full bg-black text-white px-6 py-2 text-sm md:text-base  hover:bg-gray-800" asChild>
      <Link href="/Products">Find Your Shoes</Link>
    </Button>
